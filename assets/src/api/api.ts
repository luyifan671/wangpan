...
import {
  AddSharedSpaceMemberService,
  CreateSharedSpaceService,
  ListSharedSpaceMembersResponse,
  ListSharedSpaceResponse,
  ListSharedSpaceService,
  SharedSpace,
  SharedSpaceMember,
  UpdateSharedSpaceMemberService,
} from "./space.ts";
import {
  AppRegistration,
  Capacity,
...
export function getSharedSpaces(req: ListSharedSpaceService = {}): ThunkResponse<ListSharedSpaceResponse> {
  return async (dispatch, _getState) => {
    return await dispatch(
      send(
        "/space",
...
export function sendCreateSharedSpace(req: CreateSharedSpaceService): ThunkResponse<SharedSpace> {
  return async (dispatch, _getState) => {
    return await dispatch(
      send(
        "/space",
...
export function sendUpdateSharedSpace(id: string, req: CreateSharedSpaceService): ThunkResponse<SharedSpace> {
  return async (dispatch, _getState) => {
    return await dispatch(
      send(
        "/space/" + id,
...
export function sendDeleteSharedSpace(id: string): ThunkResponse<void> {
  return async (dispatch, _getState) => {
    return await dispatch(
      send(
        "/space/" + id,
...
export function getSharedSpaceMembers(
  id: string,
  req: ListSharedSpaceService = {},
): ThunkResponse<ListSharedSpaceMembersResponse> {
  return async (dispatch, _getState) => {
    return await dispatch(
      send(
        `/space/${id}/members`,
...
export function sendAddSharedSpaceMember(
  id: string,
  req: AddSharedSpaceMemberService,
): ThunkResponse<SharedSpaceMember> {
  return async (dispatch, _getState) => {
    return await dispatch(
      send(
        `/space/${id}/members`,
...
export function sendUpdateSharedSpaceMember(
  id: string,
  memberId: string,
  req: UpdateSharedSpaceMemberService,
): ThunkResponse<SharedSpaceMember> {
  return async (dispatch, _getState) => {
    return await dispatch(
      send(
...
export function sendRemoveSharedSpaceMember(id: string, memberId: string): ThunkResponse<void> {
  return async (dispatch, _getState) => {
    return await dispatch(
      send(
        `/space/${id}/members/${memberId}`,
